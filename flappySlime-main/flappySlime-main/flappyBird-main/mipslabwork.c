        ...
        if (alive)
          {
              ...
              if(count2 = 128){
                display_clear();
                move_titlescrean(pipe1_row,pipe1_col,28, 0,216);
              }else if(count2 = 158) {
                move_titlescrean(pipe2_row,pipe2_col,22, 0,216);
                move_titlescrean(pipe3_row,pipe3_col,18, 0,216);
              }else if(count2 = 188){
                move_titlescrean(pipe6_row,pipe6_col,48, 0,216);
              }else if(count2 = 218){
                move_titlescrean(pipe4_row,pipe4_col,26, 0,216);
                move_titlescrean(pipe7_row,pipe7_col,14, 0,216);
              }else if(count2 = 248){
                move_titlescrean(pipe8_row,pipe8_col,46, 0,216);
              }else if(count2 = 278){
                move_titlescrean(pipe5_row,pipe5_col,38, 0,216);
                move_titlescrean(pipe5_row,pipe5_col,38, 0,216);
                count2 = 98;
              }
...
void labinit(void)
{
  ...
  *trisE = 0x00 & *trisE;//Sets portE to output, LED lights
  ...
  move_titlescrean(pipe1_row,pipe1_col,28, 0,30);
  move_titlescrean(pipe2_row,pipe2_col,22, 0,60);
  move_titlescrean(pipe3_row,pipe3_col,18, 0,60);
  move_titlescrean(pipe6_row,pipe6_col,48, 0,90);
  move_titlescrean(pipe4_row,pipe4_col,26, 0,120);
  move_titlescrean(pipe7_row,pipe7_col,14, 0,120);
  move_titlescrean(pipe8_row,pipe8_col,46, 0,150);
  move_titlescrean(pipe5_row,pipe5_col,38, 0,180);  
  move_titlescrean(pipe9_row,pipe9_col,10, 0,180);  
